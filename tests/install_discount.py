...
class CreateStoretrial(unittest.TestCase):
    ...
    def testcase_1(self):
        ...
        for i in range(0, 16):
            ...
            store_name = [st1, st2, st3, st4, st5,st6]

            # Password
            password = 'password@12345678'
            keyword_1 = 'Discount'
            keyword_2 = 'discount'
            key_word = [keyword_1, keyword_2]
            ...
            value_email_6 = lastname + time_str + "@" + "yahoo.com"
            ...
            value_email = [value_email_1, value_email_2, value_email_3, value_email_4, value_email_5, value_email_6, value_email_7, value_email_8, value_email_6, value_email_10, value_email_11, value_email_12]
            ...
            print(f"step 4")
            createStoreMCMA.click_create_account()
