...
BTN_DELETE_APPS = '//button[@type="button" and contains(@class, "Polaris-Button_r99lw Polaris-Button--destructive_zy6o5 Polaris-Button--plain_2z97r")]'
BTN_DELETE_APPS_CONFIRM = '//button[@type="button" and contains(@class, "Polaris-Button_r99lw Polaris-Button--primary_7k9zs Polaris-Button--destructive_zy6o5")]'
